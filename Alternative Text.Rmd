...
```
Please watch Amy Cesal's guide to writing alternative text for data visualization found [here](https://www.youtube.com/watch?v=nBcR95S0F0o). According to this video, what are the three components that alternative text for data visualization should include?

With this in mind, which of the four alternative text examples below best describe the above image:
...
Now, try your hand at writing alternative text for the data visualization below. Remember to include the chart type, type of data, and reason for including the chart in your alternative text:
...
Compare your alternative text for this data visualization with others in your group. As a group, combine your ideas to decide on the final alternative text for this data visualization. 