...
```{r example-image, fig.margin = TRUE, echo = FALSE, fig.alt = "Example Image", fig.width=3, eval = FALSE}
knitr::include_graphics("img/example_image.png")
```


🧶 ✅ ⬆️ *Yay, you're done! Commit all remaining changes, use the commit message "Finish Lab 1!* 💪*", and push. Make sure to commit and push all changed files so that your Git pane is cleared up afterwards. Before you wrap up the assignment, make sure all documents are updated on your GitHub repo.*
