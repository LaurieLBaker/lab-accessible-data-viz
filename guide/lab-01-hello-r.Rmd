...
🧶 ✅ ⬆️ *You should pause again, commit changes with the commit message "Add answer for Ex 5" and push. Make sure to commit and push all changed files so that your Git pane is cleared up afterwards.*
